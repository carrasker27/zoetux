...
<div id="wrapper">
  ...
  <div id="form-container">
    ...
    <form action="alta2.php" method="post" id="form1">
  	<fieldset>      	
        <div class="field">
          <label for="Email">Nombre:</label>
          <? if($nombre=='beto'){?>
          
          <input type="text" id="Email" name="nombre" required="required" />
          <? }else{?>
          <input type="text" value="<? echo $nombre;?>" id="Email" name="nombre" required="required" />
          <? }?>
        </div>
        ...
        <div class="field">
            ...
            <? if($no_pieza=='beto'){?>
            <input type="text" name="no_pieza" id="Email" required="required"/>
            <? } else{ ?>
            <input type="text" value="<? echo $no_pieza;?>" name="no_pieza" id="Email" required="required"/>
            <? }?>
        </div>
        ...
        <div class="field">
          ...
          <? if($descripcion=='beto'){?>
          <textarea id="Comment" name="descripcion" required="required"></textarea>
          <? }else{?>
          <textarea id="Comment" name="descripcion" required="required"><? echo $descripcion;?></textarea>
          <? }?>
        </div>
        ...
        <div class="field">
          <input type="submit" value="Alta" class="submit-button" />
        </div>
